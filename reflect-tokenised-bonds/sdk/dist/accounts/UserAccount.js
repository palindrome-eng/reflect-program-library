...
exports.userAccountBeet = exports.UserAccount = exports.userAccountDiscriminator = void 0;
const beet = __importStar(require("@metaplex-foundation/beet"));
const web3 = __importStar(require("@solana/web3.js"));
const beetSolana = __importStar(require("@metaplex-foundation/beet-solana"));
exports.userAccountDiscriminator = [211, 33, 136, 16, 186, 110, 242, 127];
/**
...
class UserAccount {
    ...
    static gpaBuilder(programId = new web3.PublicKey('6ZZ1sxKGuXUBL8HSsHqHaYCg92G9VhMNTcJv1gFURCop')) {
        return beetSolana.GpaBuilder.fromStruct(programId, exports.userAccountBeet);
    }
    /**
    ...
    static deserialize(buf, offset = 0) {
        return exports.userAccountBeet.deserialize(buf, offset);
    }
    /**
     ...
     */
    serialize() {
        return exports.userAccountBeet.serialize(Object.assign({ accountDiscriminator: exports.userAccountDiscriminator }, this));
    }
    /**
     ...
     */
    static get byteSize() {
        return exports.userAccountBeet.byteSize;
    }
    /**
    ...
    static getMinimumBalanceForRentExemption(connection, commitment) {
        return __awaiter(this, void 0, void 0, function* () {
            return connection.getMinimumBalanceForRentExemption(UserAccount.byteSize, commitment);
        });
    }
    /**
 ...
 * @category generated
 */
exports.userAccountBeet = new beet.BeetStruct([

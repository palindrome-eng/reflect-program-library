...
/// Instructions supported by the ReflectPool program.
#[repr(C)]
#[derive(Clone, Debug, PartialEq, BorshSerialize, BorshDeserialize)]
pub enum ReflectPoolInstruction {
...
pub fn initialize(
    ...
    let pool_rent = rent.minimum_balance(std::mem::size_of::<ReflectPool>());
...
pub fn initialize_pool(program_id: &Pubkey, vote_account_address: &Pubkey) -> Instruction {
    ...
    let data = borsh::to_vec(&ReflectPoolInstruction::InitializePool).unwrap();
    let accounts = vec![
...
pub fn reactivate_pool_stake(program_id: &Pubkey, vote_account_address: &Pubkey) -> Instruction {
    ...
    let data = borsh::to_vec(&ReflectPoolInstruction::ReactivatePoolStake).unwrap();
    let accounts = vec![
        AccountMeta::new_readonly(*vote_account_address, false),
...
pub fn deposit_stake(
    ...
    let data = borsh::to_vec(&ReflectPoolInstruction::DepositStake).unwrap();
...
pub fn withdraw_stake(
    ...
    let data = borsh::to_vec(&ReflectPoolInstruction::WithdrawStake {
...
pub fn create_token_metadata(
    ...
    let data = borsh::to_vec(&ReflectPoolInstruction::CreateTokenMetadata).unwrap();
...
pub fn update_token_metadata(
    ...
    let (token_metadata, _) = find_metadata_account(&pool_mint);
    let data =
        borsh::to_vec(&ReflectPoolInstruction::UpdateTokenMetadata { name, symbol, uri }).unwrap();

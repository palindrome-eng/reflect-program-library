...
pub fn program_test(enable_minimum_delegation: bool) -> ProgramTest {
    ...
    program_test.add_program("reflect_single_pool", id(), processor!(Processor::process));
...
pub struct ReflectPoolAccounts {
...
impl Default for ReflectPoolAccounts {
    fn default() -> Self {

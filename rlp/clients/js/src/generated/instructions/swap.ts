...
export function getSwapInstructionDataEncoder(): Encoder<SwapInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["fromAssetId", getU8Encoder()],
      ["toAssetId", getU8Encoder()],
    ]),
...
export function getSwapInstructionDataDecoder(): Decoder<SwapInstructionData> {
  return getStructDecoder([
    ...
    ["fromAssetId", getU8Decoder()],
    ["toAssetId", getU8Decoder()],
  ]);
}
...
> = {
  ...
  fromAssetId: SwapInstructionDataArgs["fromAssetId"];
  toAssetId: SwapInstructionDataArgs["toAssetId"];
};

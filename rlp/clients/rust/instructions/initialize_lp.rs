...
pub const INITIALIZE_LP_DISCRIMINATOR: [u8; 8] = [110, 252, 116, 251, 81, 191, 57, 96];
...
impl InitializeLp {
  pub fn instruction(&self, args: InitializeLpInstructionArgs) -> solana_instruction::Instruction {
...
impl Default for InitializeLpInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `InitializeLp`.
///
/// ### Accounts:
///
...
#[inline(always)]
  ...
  /// `initialize_lp` CPI accounts.
  pub struct InitializeLpCpiAccounts<'a, 'b> {
...
pub struct InitializeLpCpi<'a, 'b> {
...
impl<'a, 'b> InitializeLpCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: InitializeLpCpiAccounts<'a, 'b>,
...
/// Instruction builder for `InitializeLp` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` signer
...
impl<'a, 'b> InitializeLpCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(InitializeLpCpiBuilderInstruction {
      __program: program,
              signer: None,
              permissions: None,
              settings: None,
...
#[derive(Clone, Debug)]
struct InitializeLpCpiBuilderInstruction<'a, 'b> {

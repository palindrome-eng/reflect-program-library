...
pub const MIGRATE_DEAD_SHARES_DISCRIMINATOR: [u8; 8] = [4, 227, 153, 135, 240, 255, 179, 254];

/// Accounts.
#[derive(Debug)]
pub struct MigrateDeadShares {
...
impl MigrateDeadShares {
  pub fn instruction(&self, args: MigrateDeadSharesInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: MigrateDeadSharesInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = MigrateDeadSharesInstructionData::new().try_to_vec().unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct MigrateDeadSharesInstructionData {
            discriminator: [u8; 8],
            }

impl MigrateDeadSharesInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [4, 227, 153, 135, 240, 255, 179, 254],
                                }
  }
...
impl Default for MigrateDeadSharesInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct MigrateDeadSharesInstructionArgs {
                  pub pool_id: u8,
      }

impl MigrateDeadSharesInstructionArgs {
  pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
    borsh::to_vec(self)
  }
}
...
/// Instruction builder for `MigrateDeadShares`.
///
/// ### Accounts:
///
...
pub struct MigrateDeadSharesBuilder {
            signer: Option<solana_pubkey::Pubkey>,
                ...
                dead_shares_vault: Option<solana_pubkey::Pubkey>,
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = MigrateDeadShares {
                              signer: self.signer.expect("signer is not set"),
                                        ...
                                        dead_shares_vault: self.dead_shares_vault.expect("dead_shares_vault is not set"),
          ...
          let args = MigrateDeadSharesInstructionArgs {
  ...
  /// `migrate_dead_shares` CPI accounts.
  pub struct MigrateDeadSharesCpiAccounts<'a, 'b> {
...
/// `migrate_dead_shares` CPI instruction.
pub struct MigrateDeadSharesCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: MigrateDeadSharesInstructionArgs,
  }

impl<'a, 'b> MigrateDeadSharesCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: MigrateDeadSharesCpiAccounts<'a, 'b>,
              args: MigrateDeadSharesInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
              ...
              dead_shares_vault: accounts.dead_shares_vault,
  ...
  pub fn invoke_signed_with_remaining_accounts(
    ...
    account_infos.push(self.__program.clone());
                  account_infos.push(self.signer.clone());
                        ...
                        account_infos.push(self.dead_shares_vault.clone());
...
/// Instruction builder for `MigrateDeadShares` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` signer
...
#[derive(Clone, Debug)]
pub struct MigrateDeadSharesCpiBuilder<'a, 'b> {
  instruction: Box<MigrateDeadSharesCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> MigrateDeadSharesCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(MigrateDeadSharesCpiBuilderInstruction {
      __program: program,
              signer: None,
              admin: None,
              liquidity_pool: None,
              lp_token_mint: None,
              dead_shares_vault: None,
              token_program: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = MigrateDeadSharesCpi {
        __program: self.instruction.__program,
          ...
          dead_shares_vault: self.instruction.dead_shares_vault.expect("dead_shares_vault is not set"),
...
#[derive(Clone, Debug)]
struct MigrateDeadSharesCpiBuilderInstruction<'a, 'b> {
  __program: &'b solana_account_info::AccountInfo<'a>,
            signer: Option<&'b solana_account_info::AccountInfo<'a>>,
                ...
                dead_shares_vault: Option<&'b solana_account_info::AccountInfo<'a>>,

...
pub const UPDATE_PROTECTED_VAULT_DISCRIMINATOR: [u8; 8] = [12, 140, 253, 36, 18, 79, 106, 75];

/// Accounts.
#[derive(Debug)]
pub struct UpdateProtectedVault {
...
impl UpdateProtectedVault {
  pub fn instruction(&self, args: UpdateProtectedVaultInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: UpdateProtectedVaultInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = UpdateProtectedVaultInstructionData::new().try_to_vec().unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct UpdateProtectedVaultInstructionData {
            discriminator: [u8; 8],
                  }

impl UpdateProtectedVaultInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [12, 140, 253, 36, 18, 79, 106, 75],
                                              }
  }
...
impl Default for UpdateProtectedVaultInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct UpdateProtectedVaultInstructionArgs {
                  pub liquidity_pool_id: u8,
                pub new_protected_vault: Pubkey,
      }

impl UpdateProtectedVaultInstructionArgs {
  pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
    borsh::to_vec(self)
  }
}
...
/// Instruction builder for `UpdateProtectedVault`.
///
/// ### Accounts:
///
...
pub struct UpdateProtectedVaultBuilder {
            signer: Option<solana_pubkey::Pubkey>,
                ...
                new_protected_vault: Option<Pubkey>,
        __remaining_accounts: Vec<solana_instruction::AccountMeta>,
}

impl UpdateProtectedVaultBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
    ...
    pub fn program(&mut self, program: solana_pubkey::Pubkey) -> &mut Self {
      ...
      pub fn liquidity_pool_id(&mut self, liquidity_pool_id: u8) -> &mut Self {
        ...
        self
                ...
                #[inline(always)]
      pub fn new_protected_vault(&mut self, new_protected_vault: Pubkey) -> &mut Self {
        self.new_protected_vault = Some(new_protected_vault);
        self
      }
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = UpdateProtectedVault {
          ...
          let args = UpdateProtectedVaultInstructionArgs {
                                                              liquidity_pool_id: self.liquidity_pool_id.clone().expect("liquidity_pool_id is not set"),
                                                                  new_protected_vault: self.new_protected_vault.clone().expect("new_protected_vault is not set"),
                                    };
  ...
  /// `update_protected_vault` CPI accounts.
  pub struct UpdateProtectedVaultCpiAccounts<'a, 'b> {
...
/// `update_protected_vault` CPI instruction.
pub struct UpdateProtectedVaultCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: UpdateProtectedVaultInstructionArgs,
  }

impl<'a, 'b> UpdateProtectedVaultCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: UpdateProtectedVaultCpiAccounts<'a, 'b>,
              args: UpdateProtectedVaultInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `UpdateProtectedVault` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` signer
          ...
          ///   5. `[]` program
#[derive(Clone, Debug)]
pub struct UpdateProtectedVaultCpiBuilder<'a, 'b> {
  instruction: Box<UpdateProtectedVaultCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> UpdateProtectedVaultCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(UpdateProtectedVaultCpiBuilderInstruction {
      __program: program,
              signer: None,
              admin: None,
              settings: None,
    ...
    pub fn program(&mut self, program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      pub fn liquidity_pool_id(&mut self, liquidity_pool_id: u8) -> &mut Self {
        ...
        self
                ...
                #[inline(always)]
      pub fn new_protected_vault(&mut self, new_protected_vault: Pubkey) -> &mut Self {
        self.instruction.new_protected_vault = Some(new_protected_vault);
        self
      }
        /// Add an additional account to the instruction.
  #[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = UpdateProtectedVaultInstructionArgs {
                                                              liquidity_pool_id: self.instruction.liquidity_pool_id.clone().expect("liquidity_pool_id is not set"),
                                                                  new_protected_vault: self.instruction.new_protected_vault.clone().expect("new_protected_vault is not set"),
                                    };
        let instruction = UpdateProtectedVaultCpi {
...
#[derive(Clone, Debug)]
struct UpdateProtectedVaultCpiBuilderInstruction<'a, 'b> {

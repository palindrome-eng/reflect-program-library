...
export declare const isCooldownRewardsSingle: (x: CooldownRewards) => x is CooldownRewards & {
    __kind: "Single";
};
export declare const isCooldownRewardsDual: (x: CooldownRewards) => x is CooldownRewards & {
    __kind: "Dual";
};
/**
 * @category userTypes
 * @category generated
 */
export declare const cooldownRewardsBeet: beet.FixableBeet<CooldownRewards, CooldownRewards>;

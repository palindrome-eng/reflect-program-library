...
impl LiquidityPool {
    ...
    pub fn calculate_total_pool_value<'info>(
        &self,
        remaining_accounts: &'info [AccountInfo<'info>],
        liquidity_pool: &'info Account<'info, LiquidityPool>,
        settings: &'info Account<'info, Settings>,
        clock: &Clock,
    ...
    pub fn calculate_lp_tokens_on_deposit<'info>(
        &self,
        lp_token: &'info Account<'info, Mint>,
